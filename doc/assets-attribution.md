The following is a list of assets used in the coinaaa source and their proper attribution.
...
* License: MIT
* Site: [https://coinaaatalk.org/index.php?topic=15276.0](https://coinaaatalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original coinaaa logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/coinaaa.icns, src/qt/res/src/coinaaa.svg,
	src/qt/res/src/coinaaa.ico, src/qt/res/src/coinaaa.png,
	src/qt/res/src/coinaaa_testnet.png, docs/coinaaa_logo_doxygen.png,
