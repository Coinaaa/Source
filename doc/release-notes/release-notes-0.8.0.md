Coinaaa-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/coinaaa/files/Coinaaa/coinaaa-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Coinaaa
...
New/changed settings (command-line or coinaaa.conf file)
--------------------------------------------------------
