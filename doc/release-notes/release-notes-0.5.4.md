Coinaaa version 0.5.4 is now available for download at:
http://sourceforge.net/projects/coinaaa/files/Coinaaa/coinaaa-0.5.4/
...
http://gitorious.org/coinaaa/coinaaad-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Coinaaa-Qt notifications under Growl 1.3.
Increase required age of Coinaaa-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCoinaaa properly when installing Coinaaa-Qt over it. (Windows)
