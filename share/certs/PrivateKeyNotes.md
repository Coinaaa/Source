...
unlocked to sign the Coinaaa-Qt.app bundle.
...
allowing somebody to distribute a Coinaaa-Qt.app or coinaaa-qt-setup.exe with a valid
...
that the coinaaa-qt.exe file inside the installer had not been tampered with.
