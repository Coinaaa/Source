...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/coinaaa"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Coinaaa"),
     ...
     * override -datadir in the coinaaa.conf file in the default data directory
     * (to be consistent with coinaaad behavior)
     */
    if(dataDir != getDefaultDataDirectory())
