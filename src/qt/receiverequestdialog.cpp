...
#include "coinaaa-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatCoinaaaURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + CoinaaaUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatCoinaaaURI(info));
}
