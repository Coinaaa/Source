...
#ifndef H_Coinaaa_SCRIPT
#define H_Coinaaa_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CCoinaaaAddress
 */
...
public:
    ...
    // Pre-version-0.6, Coinaaa always counted CHECKMULTISIGs
